...
import { TextField, Autocomplete, Tooltip, FormControlLabel, Box, Stack, Button, Container, Slider, Typography, Switch, Chip, Card, Portal } from '@mui/material';
        ...
        <div className="base-card">
          ...
          <Card className='welcome-card' sx={{
            ...
            <Stack spacing={1.5} className='content'>
                ...
                <Box>
                <Stack>
                  <Tooltip placement="top" arrow title="Toggle on to let users choose side on the topic">
                    <FormControlLabel
                    control={<Switch checked={teams} onChange={() => setTeams(!teams)} name="gilad" />}
                    label="Teams"
                    />
                  </Tooltip>
                  <Tooltip placement="bottom" arrow title="Toggle on to let users to watch the debate without being in the video chat">
                    <FormControlLabel
                    control={
